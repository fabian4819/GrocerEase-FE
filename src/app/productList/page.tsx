    ...
    useEffect(() => {
        ...
        const generateDummyStores = () => {
            return Array.from({ length: 100 }, (_, i) => ({
                ...
                description: `Contoh deskripsi untuk toko ke-${i + 1}. Cuma untuk placeholder yak.`,
            }));
        };
        ...
        const generateDummyProducts = () => {
            ...
            return Array.from({ length: 200 }, (_, i) => ({
                product_id: `P${i + 1}`,
                name: `Product ${i + 1}`,
                description: `Description for product ${i + 1}. Lorem Ipsum sir dolor met amet`,
        ...
        const product_store: JoinedProduct[] = products.map(product => {
                                    ...
                                    const distance = haversineDistance(
                                        ...
                                        >
                                            ...
                                            <div className="w-full text-left">
                                                <p className="text-sm text-black">{product.product.description}</p>
                                            </div>
